...
private:
    ...
    void requestCoverLoadForIndex(size_t index);
    void preloadCoversAroundIndex(int index);
    ...
    static const int EAGER_COVER_LOAD_COUNT = 4;
    static const int COVER_PREFETCH_COUNT = 3;
    static const int LOAD_MORE_TRIGGER_THRESHOLD = 3;
