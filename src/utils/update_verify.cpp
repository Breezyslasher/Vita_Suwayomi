/**
 * VitaSuwayomi - update artifact signature verification (see update_verify.hpp).
 */
...
// to the stub at the bottom. CMake defines VITASUWAYOMI_HAVE_MBEDCRYPTO for the
// former set.
#if defined(VITASUWAYOMI_HAVE_MBEDCRYPTO)
...
#endif  // VITASUWAYOMI_HAVE_MBEDCRYPTO
