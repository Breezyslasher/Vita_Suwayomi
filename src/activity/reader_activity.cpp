...
void ReaderActivity::onContentAvailable() {
    ...
    if (transitionBox) {
        ...
        transitionBox->setCustomBackground(Application::getInstance().isVaporwaveTheme() ? nvgRGBA(20, 0, 40, 255) : nvgRGBA(20, 20, 30, 255));
...
void ReaderActivity::showPageError(const std::string& message) {
    ...
    m_errorOverlay->setBackgroundColor(Application::getInstance().isVaporwaveTheme() ? nvgRGBA(30, 0, 50, 200) : nvgRGBA(26, 26, 46, 200));
    ...
    m_retryButton->setBackgroundColor(Application::getInstance().isVaporwaveTheme() ? nvgRGBA(255, 50, 200, 255) : nvgRGBA(0, 150, 136, 255));
